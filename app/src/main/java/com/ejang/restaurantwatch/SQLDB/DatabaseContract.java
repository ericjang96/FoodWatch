...
public final class DatabaseContract {
    ...
    {
        public static final String INSPECTION_TABLE_NAME = "restaurants";
    ...
    private static final String SQL_CREATE_RES_TABLE =
            "CREATE TABLE " + RestaurantTable.RES_TABLE_NAME + " (" +
    ...
    private static final String SQL_DELETE_INSPECTION_TABLE =
